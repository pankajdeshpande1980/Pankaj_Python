...
def process_symbols_file(input_path: str, output_path: str) -> None:
    """
    ...
    Args:
        ...
        output_path (str): Path to save the final list of symbols.
    """
    ...
    final_df.to_csv(output_path, index=False)                           # Step 5: Save the final symbol list to a new CSV file
    
    print(f"✅ Final symbol list saved to:\n{output_path}")             # Step 6: Print success message with output path
...
if __name__ == "__main__":
    ...
    output_file_path = r'C:\Python_PD\PD_Python\fno_yahoo_symbols.csv'    # Path to save final output symbol list

    process_symbols_file(input_file_path, output_file_path)               # Call the main function
